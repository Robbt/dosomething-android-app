...
public class SomethingFragment extends Fragment {
    ...
    private class EatListElement extends BaseListElement {
        ...
        public EatListElement(int requestCode) {
            super(getActivity().getResources().getDrawable(R.drawable.add_food),
                    ...
                    null,
                    requestCode);
            foodChoices = getActivity().getResources().getStringArray(R.array.action_types);
        ...
        private void showMealOptions() {
            String title = getActivity().getResources().getString(R.string.select_activity);
        ...
        private void getCustomFood() {
            String title = getActivity().getResources().getString(R.string.enter_activity);
    ...
    // need to modify this to query friends and match them with friends existing as active on server
    private class PeopleListElement extends BaseListElement {
        ...
        protected void onActivityResult(Intent data) {
            //selectedUsers = ((DoSomethingApplication) getActivity().getApplication())
              //      .getSelectedUsers();
            setUsersText();
            notifyDataChanged();
        }
    ...
    private class LocationListElement extends BaseListElement {
        ...
        @Override
        protected void onActivityResult(Intent data) {
            //selectedPlace = ((DoSomethingApplication) getActivity().getApplication())
              //      .getSelectedPlace();
            setPlaceText();
            notifyDataChanged();
        }
