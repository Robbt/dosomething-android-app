...
public abstract class PickerFragment extends Fragment {
     ...
     */
    public static final String SHOW_PICTURES_BUNDLE_KEY = "com.eutectoid.dosomething.widget.PickerFragment.ShowPictures";
    /**
     ...
     */
    public static final String EXTRA_FIELDS_BUNDLE_KEY = "com.eutectoid.dosomething.widget.PickerFragment.ExtraFields";
    /**
     * The key for a boolean parameter in the fragment's Intent bundle to indicate whether the
     * picker should display a title bar with a Done button.
     */
    public static final String SHOW_TITLE_BAR_BUNDLE_KEY = "com.eutectoid.dosomething.widget.PickerFragment.ShowTitleBar";
    /**
     * The key for a String parameter in the fragment's Intent bundle to indicate the text to
     * display in the title bar.
     */
    public static final String TITLE_TEXT_BUNDLE_KEY = "com.eutectoid.dosomething.widget.PickerFragment.TitleText";
    /**
     * The key for a String parameter in the fragment's Intent bundle to indicate the text to
     * display in the Done button.
     */
    public static final String DONE_BUTTON_TEXT_BUNDLE_KEY = "com.eutectoid.dosomething.widget.PickerFragment.DoneButtonText";
